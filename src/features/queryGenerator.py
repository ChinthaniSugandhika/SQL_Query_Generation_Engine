...
def conditionConcatenator(conditionAttributeList, operatorSymbolList, conditionValueList, concatenatingOperatorList,
    ...
    count = 0
    condition = ''
    #if (not (not conditionAttributeList and not operatorSymbolList and conditionValueList and not concatenatingOperatorList and join)):
    #if not conditionValueList
    while count < length:
